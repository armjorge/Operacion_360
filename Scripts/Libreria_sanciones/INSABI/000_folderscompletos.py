...
def search_text_in_pdf(root_directory):
    all_data = []
...
def main():
    ...
    summary_data = search_text_in_pdf(root_directory)    
    if summary_data:
        ...
        """
        # Reemplazar la data en los googlesheets
        print("\n*******************************\nReemplazando información en google sheet\n*******************************\n")
        gsheet_SANCIONESINSABI = spreadsheet.worksheet('Sanciones_INSABI')
        gsheet_SANCIONESINSABI.clear()
        set_with_dataframe(gsheet_SANCIONESINSABI, final_data)
        print("\n*******************************\nReemplazadas\n*******************************\n")
        """
