...
def correccion_types(df_entregas_o_altas, df_facturas, info_types):
    ...
    if info_types == 'IMSS': 
        ...
        # 1) Primero, reemplaza ±inf por NaN
        ...
        # 2a) Si quieres conservar NA como NA, usa el dtype entero “nullable”:
        ...
        mask = df_facturas['Referencia'].isna() & df_facturas['Alta'].isna()
...
if __name__ == "__main__":
    ...
    folder = r"C:\Users\arman\Dropbox\3. Armando Cuaxospa\Adjudicaciones\Licitaciones 2025\E115 360\Implementación\Facturas\IMSS"
    ...
    info_types = 'IMSS'
    validacion_de_paqs(dict_path_sheet, dic_columnas, folder, df_entregas_o_altas, info_types)